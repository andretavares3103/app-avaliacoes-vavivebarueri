...
APP_URL = "https://app-avaliacoes-vavivebarueri.streamlit.app"

st.set_page_config(page_title="Avaliação Vavivê Barueri", layout="wide")
...
st.title("BARUERI || Portal de Avaliação Vavivê")
